...
define('HASH_TOKEN_KEY', 'abcxyzCV2017');
define('HASH_PASSWORD_KEY', 'yxzabcCV2017');
define('HASH_ALGO', 'sha256'); //md5, sha1, sha256, haval160,4
define('OWNERMAIL','owner@gmail.com'); //Email
